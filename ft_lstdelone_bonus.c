...
/*   Updated: 2023/11/12 21:43:16 by elchakir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     // If node was not set to NULL after deletion and you tried to use it, it would be an error
//     // printf("%d\n", *(int *)
// 	printf("Node has been deleted.\n");

// // In practice, we cannot (and don't need to) prove that 'node' has been freed in this test program.
